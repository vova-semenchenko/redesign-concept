...
Redesign of the uapp.group home page: documentation lives in `docs/` (brief, research, client-mandated style tokens in `docs/references-research.md`, final logo `docs/research/assets/logo-uapp.svg`); the prototype is a Next.js app in `uapp-site/`.
...
- `docs/references-research.md` — client-mandated tokens (colors/fonts/logo) and annotated visual references; in code they live as tokens in `uapp-site/src/styles/globals.css`.
