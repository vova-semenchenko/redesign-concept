...
- `docs/raw-briefs/uapp-redesign-brief.md` — full context: business goal, audience, positioning, block flow, mandated copy.
...
- **Never rewrite mandated copy — and verify against the brief on every text change.** The client brief (§1, §8, §11) fixes the content and message of the hero, positioning band, expertise, case studies, and the AI block. Wording may be refined; positioning may not. Writing original copy for these blocks or globally replacing text is forbidden. Before changing any prototype text, determine the block's freedom level: **mandated** — hero, positioning band, expertise cards, selected work, AI block, approach (wording refinements only); **editable** — Solutions, and the choice among the brief's three H1 options; **free** — microcopy, labels, navigation, form states. For mandated blocks, check against the verbatim brief text (§8). Voice and tone for free blocks follow the brief's brand qualities (§4) and the register of the mandated copy.
