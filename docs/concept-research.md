# UAPP — концепт-ресьорч: токени бренду та візуальний напрямок

Дві частини з різним статусом. **Розд. 1–4 — мандат клієнта** (палітра, шрифти, лого, семантичні пари): значення звідси не вигадуються і не змінюються. **Розд. 5–8 — матеріал дизайнера** (напрямки, рух, ілюстрації, візуальні референси): робочий орієнтир, відкритий до обговорення — кожна з цих секцій це проговорює й у власному тексті.
