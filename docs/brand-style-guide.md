...
На відміну від розд. 1–3, це не задані клієнтом токени, а пропозиція дизайнера (ефекти й рух — зона відповідальності дизайнера, не брендбуку). Фіксується сам факт, що такий інструментарій доречний для UAPP, без конкретного темпу, тривалості чи виконання — вони узгоджуються на етапі макету.
...
### 8.6. Детальний розбір ширшого ряду бенчмарків

14 fintech-сайтів + анти-патерни — у [`../research/02-visual-benchmark.md`](../research/02-visual-benchmark.md).

### 8.7. Спільний знаменник — що це означає для нашого сайту
...
### 8.8. Додаткові посилання (без розбору, щоб не загубити)
