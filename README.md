...
> **Про скріни у Figma:** сторінки референс-сайтів перенесені у Figma браузерним розширенням — це ті самі сайти, що розібрані у Styleguide, але при імпорті можливі артефакти (зсуви верстки, підміна шрифтів). Першоджерело — живі сайти та скриншоти в `assets/screenshots/`; Figma-копії зручні для розмітки й порівняння поруч.
