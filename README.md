...
2. **[Styleguide](docs/references-research.md)** — токени бренду та візуальні референси з розбором «що беремо для UAPP» (розд. 8).
...
| [`docs/references-research.md`](docs/references-research.md) | Стильові токени за брендбуком + семантичні пари світла/темна поверхня + візуальні референси |
